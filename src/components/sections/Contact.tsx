...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="snap-section flex flex-col items-center justify-center px-4 py-20">
      <div className="max-w-xl mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="bg-accent text-accent-foreground font-display text-lg py-3 rounded-lg hover:bg-accent/90 transition-colors"
          >
            {t.contact.send}
          </button>
        </form>
